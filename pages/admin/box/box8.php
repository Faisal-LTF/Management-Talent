...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class=" text-center mb-3">
            <a href="home.php" class="btn btn-warning">BOX 8 <br> <br> KINERJA DIATAS EKSPEKTASI DAN POTENSI MENENGAH
            </a>
        </div>
        <div class="card">
                ...
                <table id="example" class="table align-items-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            WHERE n.np BETWEEN 71 AND 90 AND n.nk BETWEEN 91 AND 100");
                            $i = 1;
