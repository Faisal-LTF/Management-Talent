...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_GET['id'];
    $query = $link->query("SELECT * FROM pegawai WHERE id_pegawai = '$id'");
                        ...
                        <form data-toggle="validator" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="basic-icon-default-fullname"
                                        ...
                                        aria-describedby="basic-icon-default-fullname2" value="<?= $data['nama'] ?>" />
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="basic-icon-default-fullname"
                                        placeholder="Tanggal Lahir" name="tempatLahir" aria-label="Tempat Lahir"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="basic-icon-default-alamat" class="form-control"
                                        ...
                                        aria-describedby="basic-icon-default-alamat" value="<?= $data['alamat'] ?>" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="basic-icon-default-fullname"
                                        ...
                                        aria-describedby="basic-icon-default-fullname2" value="<?= $data['nip'] ?>" />
                                </div>
                            </div>
                            <div class="mb-3">
...
WHERE id_pegawai = '$id'");
    ...
    Swal.fire({
        ...
        window.location.href = '?page=edit_pegawai'; 
    });
</script>";
        }
    }
