                    ...
                    <table id="example" class="table align-items-center">
                        ...
                        <tbody>
                            ...
                            while ($row = $query->fetch_array()) {
                                $boxName = "Box 1"; // Default: Box 1

                                if ($row['np'] < 70 && $row['nk'] < 70) {
                                    $boxName = "Box 1";
                                } elseif ($row['np'] >= 70 && $row['np'] <= 90 && $row['nk'] < 70) {
                                    $boxName = "Box 2";
                                } elseif ($row['np'] >= 91 && $row['np'] <= 100 && $row['nk'] < 70) {
                                    $boxName = "Box 3";
                                } elseif ($row['np'] < 70 && $row['nk'] >= 70 && $row['nk'] <= 90) {
                                    $boxName = "Box 4";
                                } elseif ($row['np'] >= 70 && $row['np'] <= 90 && $row['nk'] >= 70 && $row['nk'] <= 90) {
                                    $boxName = "Box 5";
                                } elseif ($row['np'] >= 91 && $row['np'] <= 100 && $row['nk'] >= 70 && $row['nk'] <= 90) {
                                    $boxName = "Box 6";
                                } elseif ($row['np'] < 70 && $row['nk'] >= 91 && $row['nk'] <= 100) {
                                    $boxName = "Box 7";
                                } elseif ($row['np'] >= 71 && $row['np'] <= 90 && $row['nk'] >= 91 && $row['nk'] <= 100) {
                                    $boxName = "Box 8";
                                } elseif ($row['np'] >= 91 && $row['np'] <= 100 && $row['nk'] >= 91 && $row['nk'] <= 100) {
                                    $boxName = "Box 9";
                                }
                                    ...
                                    <td class="w-5">
                                        <div class=" mt-3">
                                            ...
                                            <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4" role="menu">
                                                <li><a class="dropdown-item border-radius-md" href="?page=edit_nilai&id=<?= $row[0]; ?>"><i class="fa fa-edit"></i>
                                                        Edit Data</a></li>
