...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_GET['id'];
    $query = $link->query("SELECT * FROM nilai n join pegawai p on n.id_pegawai = p.id_pegawai  WHERE id_nilai = '$id' ");
    $data = $query->fetch_array();


    $skp = null;
    if (@$_GET['id']) {
        $skp = $link->query("SELECT * FROM nilai WHERE id_nilai = '$_GET[id]'")->fetch_assoc();
    }
?>
...
<div class="content-wrapper">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <div class="col-6 col-md-3">
                                            <input placeholder="Disabled" step="0.1" type="number" name="nk"
                                                ...
                                                data-label="#nilai_kinerja_label" readonly>
                                        </div>
                                        <div class="col-6 col-md-2">
    ...
    if (isset($_POST['edit'])) {
        ...
        $edit = $link->query("UPDATE nilai SET 
...
window.location.href = '?page=edit_nilai'; 
});
</script>";
        }
    }
