...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = `?page=hapus_kinerja&id=${id}`;
        }
    });
}
</script>
...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col-12 text-end mb-3">
            <a href="?page=tambah_kinerja" class="btn btn-primary">Tambah Data</a>
        </div>
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <table id="example" class="table align-items-center">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $query = mysqli_query($link, "SELECT * FROM kinerja k join pegawai p on k.id_pegawai = p.id_pegawai");
                            $i = 1;
                                ...
                                <div class=" mt-3">
                                    ...
                                    <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4"
                                        ...
                                        <li><a class="dropdown-item border-radius-md"
                                                href="?page=edit_kinerja&id=<?= $row[0]; ?>"><i class="fa fa-edit"></i>
                                                Edit Data</a></li>
                                        <li><a class="dropdown-item border-radius-md"
